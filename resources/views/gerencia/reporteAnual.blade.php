                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="cmbAnioGerencia">Año</label>
                            <select class="js-example-basic-single" style="width: 100%; color:#184f4f; background-color:#184f4f;" name="cmbAnioGerencia" id="cmbAnioGerencia">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="cmbAnioGerenciaSemanaInicio">Semana Inicio</label>
                            <select class="js-example-basic-single" style="width: 100%; color:#184f4f; background-color:#184f4f;" name="cmbAnioGerenciaSemanaInicio" id="cmbAnioGerenciaSemanaInicio">
                                <option value="0">Selecione</option>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="cmbAnioGerenciaSemanaFin">Semana Fin</label>
                            <select class="js-example-basic-single" style="width: 100%; color:#184f4f; background-color:#184f4f;" name="cmbAnioGerenciaSemanaFin" id="cmbAnioGerenciaSemanaFin">
                                <option value="0">Selecione</option>
                                @forelse(range(1,50) as $dia)
                                <option value="{{$dia}}">Semana {{$dia}}</option>
                                @empty
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="btnBuscarGerencia"></label>
                            <br>
                            <button id="btnBuscarGerencia" name="btnBuscarGerencia" type="button" class="btn btn-info mt-2"> <i class="fa fa-search" aria-hidden="true"></i> Consultar</button>
                        </div>
