...
class CreateTableVentas2020Otras extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('table_ventas_2020_otras', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('table_ventas_2020_otras');
    }
}
