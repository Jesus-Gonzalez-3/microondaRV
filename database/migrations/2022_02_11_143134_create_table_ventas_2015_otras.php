...
class CreateTableVentas2015Otras extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('table_ventas_2015_otras', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('table_ventas_2015_otras');
    }
}
