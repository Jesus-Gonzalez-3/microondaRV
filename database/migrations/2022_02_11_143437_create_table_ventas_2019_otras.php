...
class CreateTableVentas2019Otras extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('table_ventas_2019_otras', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('table_ventas_2019_otras');
    }
}
