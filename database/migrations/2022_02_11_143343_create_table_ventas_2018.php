...
class CreateTableVentas2018 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ventas_2018', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('BODEGA')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('table_ventas_2018');
    }
}
